<?php
	...
	function getOrangeImg($srcURL, $colour='#ff0000', $width, $height, $valign, $jpg_quality=75, $forceOverwrite=false){

		$blendedURL  = preg_replace('/(\.jpg|\.jpeg)/i', '-orange$1', $srcURL);    /* absolute to the docroot, without the domain name */
